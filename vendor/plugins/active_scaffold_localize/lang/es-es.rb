ActiveScaffold::Localization.define('es-es') do |lang|
  ...
  lang['%d %s found'] ||= '%d %s encontrados'
  lang['(Filtered)'] ||= '(filtrado)'
  lang['Found'] ||= 'Encontrado'
  lang['Live Search'] ||= 'Busqueda activa'
  ...
  lang['Print'] || 'Imprimir'
  lang['Remove'] ||= 'Remover'
  lang['Remove file'] ||= 'Remover or Reemplazar archivo'
  lang['Replace With New'] ||= 'Reeplazar con Nuevo'
  lang['Reset'] ||= 'Restaurar'
  lang['Saving…'] ||= 'Salvando…'
  lang['Search'] ||= 'Buscar'
  lang['Search Terms'] ||= 'Buscar Terminos'
  lang['_select_'] ||= ' - seleccione -'
  lang['Show'] ||= 'Mostrar'
  ...
  lang['Hide'] ||= 'Ocultar'
  lang['Nested_for_model %s'] ||= 'Edicion del modelo %s'

  
  # AS error messages
  lang['Version inconsistency - this record has been modified since you started editing it.'] ||= 'Version inconsistente - este registro ha sido modificado desde el inicio de edicion.'
  ...
  lang['%d error prohibited this %s from being saved'] ||= {1 => '%d error evita que este %s sea salvado', 2 => '%d error que este %s sea salvado'}
  ...
  lang[:date_helper] = {
    ...
    :calendar_tool_tip => 'Click para mostrar Calendario
o intente estos enlaces:
hoy (tod)
mañana (tom)
ayer
6 (6 de Octubre)
